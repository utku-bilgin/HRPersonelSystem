...
namespace HRPersonnelSystem.DAL.Migrations
{
    ...
    [Migration("20231018171435_AddSeedDatas")]
            ...
            modelBuilder.Entity("HRPersonnelSystem.Entities.AdvancePayment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 5000m,
                            ApprovalStatus = 2,
                            CreatedDate = new DateTime(2023, 10, 18, 20, 14, 33, 383, DateTimeKind.Local).AddTicks(5741),
                            CurrencyUnit = 2,
            ...
            modelBuilder.Entity("HRPersonnelSystem.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "9287bd34-de46-4fd3-8c94-737b64136bce",
                            Name = "Employee",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "03ac2b0c-e7d9-48df-a8b9-1139f4e741fa",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "13e658f7-fc79-4888-8129-559041275e4a",
                            Name = "Admin",
            ...
            modelBuilder.Entity("HRPersonnelSystem.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContractEndDate = new DateTime(2025, 10, 18, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(558),
                            ContractStartDate = new DateTime(2023, 2, 18, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(554),
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 10, 18, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(527),
                            ...
                            YearOfEstablishment = new DateTime(1998, 10, 18, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(550)
                        },
                        new
                        {
                            ...
                            CompanyTitle = "LTD.ŞTI.",
                            ContractEndDate = new DateTime(2024, 10, 18, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(575),
                            ContractStartDate = new DateTime(2023, 9, 18, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(573),
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 10, 18, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(565),
                            ...
                            TaxOffice = "Aksaray V.D",
                            YearOfEstablishment = new DateTime(2018, 10, 18, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(571)
                        });
                });
            ...
            modelBuilder.Entity("HRPersonnelSystem.Entities.Expenditure", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 10, 18, 20, 14, 33, 383, DateTimeKind.Local).AddTicks(6677),
                            CurrencyUnit = "TL",
                            EmployeeId = new Guid("7db5918a-64b7-4d74-8d16-bb52fa969631"),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 10, 18, 20, 14, 33, 383, DateTimeKind.Local).AddTicks(6740),
                            CurrencyUnit = "TL",
                            EmployeeId = new Guid("7db5918a-64b7-4d74-8d16-bb52fa969631"),
            ...
            modelBuilder.Entity("HRPersonnelSystem.Entities.Permission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApprovalStatus = "Bekleyen",
                            CountOfDay = 21,
                            CreatedDate = new DateTime(2023, 10, 18, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(2979),
                            EmployeeId = new Guid("7db5918a-64b7-4d74-8d16-bb52fa969631"),
                            Gender = 1,
                            IsActive = true,
                            IsDeleted = false,
                            PermissionType = "Askerlik",
                            RequestDate = new DateTime(2023, 10, 18, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(2991),
                            StartDate = new DateTime(2023, 11, 7, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(2987)
                        },
                        new
                        {
                            ...
                            ApprovalStatus = "Bekleyen",
                            CountOfDay = 5,
                            CreatedDate = new DateTime(2023, 10, 18, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(3030),
                            EmployeeId = new Guid("7db5918a-64b7-4d74-8d16-bb52fa969631"),
                            Gender = 1,
                            IsActive = true,
                            IsDeleted = false,
                            PermissionType = "Babalık",
                            RequestDate = new DateTime(2024, 1, 16, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(3034),
                            StartDate = new DateTime(2024, 1, 26, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(3033)
                        },
                        new
                        {
                            ...
                            CountOfDay = 3,
                            CreatedDate = new DateTime(2023, 10, 18, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(3042),
                            EmployeeId = new Guid("7db5918a-64b7-4d74-8d16-bb52fa969631"),
                            Gender = 1,
                            IsActive = true,
                            IsDeleted = false,
                            PermissionType = "Hastalık",
                            RequestDate = new DateTime(2023, 10, 18, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(3046),
                            StartDate = new DateTime(2023, 10, 18, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(3045)
                        },
                        new
                        {
                            ...
                            ApprovalStatus = "Onaylandı",
                            CountOfDay = 3,
                            CreatedDate = new DateTime(2023, 10, 18, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(3052),
                            EmployeeId = new Guid("7db5918a-64b7-4d74-8d16-bb52fa969631"),
                            Gender = 1,
                            IsActive = true,
                            IsDeleted = false,
                            PermissionType = "Evlilik",
                            RequestDate = new DateTime(2024, 8, 13, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(3058),
                            StartDate = new DateTime(2024, 9, 7, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(3055)
                        },
                        new
                        {
                            ...
                            ApprovalStatus = "Reddedildi",
                            CountOfDay = 5,
                            CreatedDate = new DateTime(2023, 10, 18, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(3065),
                            EmployeeId = new Guid("7db5918a-64b7-4d74-8d16-bb52fa969631"),
                            Gender = 1,
                            IsActive = true,
                            IsDeleted = false,
                            PermissionType = "Yıllık",
                            RequestDate = new DateTime(2024, 7, 14, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(3068),
                            StartDate = new DateTime(2024, 7, 19, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(3067)
                        },
                        new
                        {
                            ...
                            ApprovalStatus = "Reddedildi",
                            CountOfDay = 10,
                            CreatedDate = new DateTime(2023, 10, 18, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(3076),
                            EmployeeId = new Guid("7db5918a-64b7-4d74-8d16-bb52fa969631"),
                            Gender = 1,
                            IsActive = true,
                            IsDeleted = false,
                            PermissionType = "Refakat",
                            RequestDate = new DateTime(2024, 5, 3, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(3081),
                            StartDate = new DateTime(2024, 5, 5, 20, 14, 33, 416, DateTimeKind.Local).AddTicks(3079)
                        });
                });
            ...
            modelBuilder.Entity("HRPersonnelSystem.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "341dd073-73a0-4d5d-8c34-8a744dc614a1",
                            Email = "erden.timur@bilgeadam.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ERDEN.TIMUR@BILGEADAM.COM",
                            NormalizedUserName = "ERDEN.TIMUR@BILGEADAM.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEKXq+f5DQwLWgCe72/aTYkYMVcZbDcoI33DmYgzNbBoxQu+5WlmbMHC/otIPAjMAkA==",
            ...
            modelBuilder.Entity("HRPersonnelSystem.Entities.CompanyDirector", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "590c8ffa-cb4f-4d60-b781-f2965867583d",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEEm+rnqOjy2gPdeLQCqk8ao9yfzZ0LaoCCNa5pCaw1DrgixXSNojimqS9ZyRHAToOg==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "153269f9-55e9-416e-9f82-fad80589e659",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEAaN3ECUav35i22ocQfgAI5ADotiWCoXGrQzXeUt804QJGgVS4K/4hlxOcYEb+hdyQ==",
            ...
            modelBuilder.Entity("HRPersonnelSystem.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "07c424e1-40af-4f8c-8fb0-e7160fda87ba",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAECy50a82l0UMDZmOHMqnwhFpuGFNmG+9kxCn8SBALcnwm2cOT9MOPFmSfRbUWtGHuQ==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8778a3cc-48db-490f-b10d-2226b959706d",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEK0za8OXK9q3NTZBLmmuVvDQex1YYff13X/ix0TkMzhqrkqhOOEEsq/XTbvFpOzxgA==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "1897c0dd-8784-4fb1-9948-72dce652857a",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEL78jAQOWmk6iUw/Y+Ig1mFVos3wAWE3m0Iv2qyrkT14tt1kR1Cp9TDrLlTKp2EcHQ==",
